...
class AccountChartTemplate(models.AbstractModel):
    ...
    # # cu_private
    # @template('cu_private', 'account.tax.group')
    # def _get_cu_private_account_tax_group(self):
    #     return self._parse_csv('cu_private', 'account.tax.group', module='l10n_cu')
    #
    # @template('cu_private', 'account.tax')
    # def _get_cu_private_account_tax(self):
    #     tax_data = self._parse_csv('cu_private', 'account.tax', module='l10n_cu')
    #     self._deref_account_tags('cu_private', tax_data)
    #     return tax_data
    #
    # @template('cu_private', 'account.fiscal.position')
    # def _get_cu_private_account_fiscal_position(self):
    #     return self._parse_csv('cu_private', 'account.fiscal.position', module='l10n_cu')
    #



    # # cu_tcp
    # @template('cu_tcp', 'account.tax')
    # def _get_cu_tcp_account_tax(self):
    #     tax_data = self._parse_csv('cu_tcp', 'account.tax', module='l10n_cu')
    #     self._deref_account_tags('cu_tcp', tax_data)
    #     return tax_data
    ...
    # #     if not company.chart_template and not self.existing_accounting(company):
...
#         ('name_company_uniq', 'unique(name, type_tax_use, tax_scope)', 'Tax names must be unique !'),
#     ]
#
...
#             [
#                 # TODO refactorizar
#                 # ('chart_template_id.country_id', '=', country.id)
#             ]
#         )
